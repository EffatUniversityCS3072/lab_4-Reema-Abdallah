...
```{r}
# Train Linear Discriminant Analysis (LDA) mode.
...
```{r}
# Classification and Regression Trees (CART) mode
# Set the seed for reproducibility
set.seed(100)
...
```{r}
# Train k-Nearest Neighbors (KNN) mode
# Set the seed for reproducibility
set.seed(100)
...
The most accuarate models were the KNN model with accuracy 98.3% and LDA model with accuracy 97.5% 
